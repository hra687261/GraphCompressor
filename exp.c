...
// plot 'exp_vals_power' u 1:2 w l t 'gamma', 'exp_vals_power' u 1:3 w lp t 'delta', 'exp_vals_power' u 1:4 w lp t 'nibble'

/*
gnuplot -p -e "set grid; set xlabel 'expected length (number of bits)'; set ylabel 'alpha'; set key outside; plot 'exp_vals_power' u 1:2 w lp t 'gamma encoding', 'exp_vals_power' u 1:3 w lp t 'delta encoding', 'exp_vals_power' u 1:4 w lp t 'nibble encoding', 'exp_vals_power' u 1:5 w lp t 'zeta_2', 'exp_vals_power' u 1:6 w lp t 'zeta_3', 'exp_vals_power' u 1:7 w lp t 'zeta_4', 'exp_vals_power' u 1:8 w lp t 'zeta_5'"
